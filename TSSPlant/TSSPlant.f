...
c   KAUST 
c
c   Plant Promoter Prediction Program  
c
...
c ______ Get parameters ______ 
	...
	iargno=iargc()
	if((iargno.lt.1).or.(iargno.gt.5))then 
	    call help
            stop
	endif
 ...
 1045			continue
	...
	vs(1)(1:14)='visan_tata.dat'
 	vs(2)(1:18)='visan_tataless.dat'
  	...
  	prt=0
 	if((pr(2)(1:1).eq.'y').or.(pr(2)(1:1).eq.'Y'))prt=1

 	ptype=1
 	if((pr(4)(1:1).eq.'n').or.(pr(4)(1:1).eq.'N'))ptype=0
	...
	do i=1,300
		if(pr(5)(i:i).ne.' ')goto 7987
	enddo
 7987	k1=i
 	k2=len1(pr(5))		
	inter=intr(pr(5),k1,k2)
